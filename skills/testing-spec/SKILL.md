...
**Steps 0b–0c — extract spec sources and generate the matrix:** follow `./references/spec-generation.md` (Gherkin `.feature`, PRD/requirement Markdown, and issue extraction → raw matrix rows), then continue with Step 0d.
